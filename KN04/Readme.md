...
![alt keypair-at-launch](img/keypair-at-launch.png)
## Screenshot mit dem ssh-Befehl und des Resultats unter Verwendung des ersten Schlüssels.
![alt first-key-success](img/first-key-success.png)
## Screenshot mit dem ssh-Befehl und des Resultats unter Verwendung des zweiten Schlüssels.
![alt second-key-denied](img/second-key-denied.png)
...
![alt auszug-cloud-init](img/auszug-cloud-init.png)
